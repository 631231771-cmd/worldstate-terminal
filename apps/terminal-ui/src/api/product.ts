import type { DisplayQuote, LiveGcResponse, OfficialHeadline, ProductCountryDetail, ProductEventDetail, ProductEventsResponse, ProductMacroResponse, ProductMarketsResponse, ProductTodayResponse, WorkbenchFactor } from "../types/product";
...
export const productApi = {
  ...
  productLiveGc: () => request<LiveGcResponse>("/v2/product/live-gc", undefined, [], 3_000),
